...
def create_ride():
	...
	allusers = requests.get(url = 'http://my-load-balancer-905272440.us-east-1.elb.amazonaws.com/api/v1/users', headers=headers)#public dns of load balancer should come here
...
def list_ride_details(ride_id):
	...
	if existing_ride_id.json():
		response_ride = requests.post(url=urlr, json={"table": "Ride", "ride_id": ride_id, "col":0i })
